	<div style="margin-top: 10px" id="lz-foo" class="w3-center w3-card-2 w3-light-grey">
		<div>
			<a href="<?php $this->options->footerGithub(); ?>" class="fa fa-github fa-lg"></a>
			<a href="<?php $this->options->footerWeibo(); ?>" class="fa fa-weibo fa-lg"></a>
			<a href="<?php $this->options->footerEmail(); ?>" class="fa fa-envelope fa-lg"></a>
			<a href="<?php $this->options->feedUrl(); ?>" class="fa fa-feed fa-lg"></a>
		</div>
		<div>
			<?php $this->options->accessCode(); ?>
		</div>
